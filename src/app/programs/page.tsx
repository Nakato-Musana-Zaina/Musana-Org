        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          <Reveal className="grid gap-12 lg:grid-cols-12 lg:gap-16">
            <div className="lg:col-span-7">
              <span className="font-mono text-sm text-leaf-deep">01 &mdash; Orphan Care & Education</span>
              ...
              <ul className="mt-8 grid gap-3 sm:grid-cols-2">
                {[
                  ...
                  <li key={item} className="flex items-start gap-3 rounded-xl bg-white/60 p-4 font-body text-sm text-charcoal/80">
            ...
            <div className="lg:col-span-5">
              <div className="sticky top-24 rounded-3xl bg-sun-pale p-8">
                <p className="font-display text-xl font-semibold text-charcoal">
                  Sponsor a child
                </p>
                <p className="mt-3 font-body text-sm leading-relaxed text-charcoal/75">
                  For UGX 100,000 a month, you can cover one orphan&apos;s
